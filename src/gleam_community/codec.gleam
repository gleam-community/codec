...
///
///
pub fn custom1(match: fn(a, value) -> Json,) -> Builder(fn(a) -> fn(value) -> Json, value) {
  Builder(function.curry2(match), map.new())
}

///
///
pub fn custom2(match: fn(a, b, value) -> Json,) -> Builder(fn(a) -> fn(b) -> fn(value) -> Json, value) {
...
///
///
pub fn variant0(builder: Builder(fn(Json) -> a, value), tag: String, value: value) -> Builder(a, value) {
  variant(builder, tag, fn(f) { f([]) }, fn(_) { Ok(value) })
}

///
///
pub fn variant1(builder: Builder(fn(fn(a) -> Json) -> b, value), tag: String, value: fn(a) -> value, codec: Codec(a)) -> Builder(b, value) {
  variant(
    builder,
    tag,
